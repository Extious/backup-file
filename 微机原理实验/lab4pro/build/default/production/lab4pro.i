...
# 48 "C:/Users/zhaozhan/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.7.146/xc8\pic\include\proc\pic16f18854.inc"
INDF0 equ 0000h
...
# 8 "C:/Users/zhaozhan/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.7.146/xc8\pic\include\pic.inc"
stk_offset SET 0
auto_size SET 0
...
banksel PIR0
bcf PIR0, 5
; ((INTCON) and 07Fh), 7, PIE enable
banksel INTCON
bsf INTCON, 7
bsf INTCON, 6
; ((PIE0) and 07Fh), 5 enable
banksel PIE0
bsf PIE0, 5
...
Table_1:; Attention: ((PORTA) and 07Fh), 7 == ((PORTA) and 07Fh), 6
addwf PCL, f
retlw 00000110B ;1
retlw 11011011B ;2
retlw 11001111B ;3
retlw 11100110B ;4
Table_2:; Attention: ((PORTA) and 07Fh), 7 == ((PORTA) and 07Fh), 6
addwf PCL, f
retlw 11100110B ;4
retlw 00000110B ;1
retlw 11011011B ;2
retlw 11001111B ;3
Table_3:; Attention: ((PORTA) and 07Fh), 7 == ((PORTA) and 07Fh), 6
addwf PCL, f
retlw 11001111B ;3
retlw 11100110B ;4
retlw 00000110B ;1
retlw 11011011B ;2
Table_4:; Attention: ((PORTA) and 07Fh), 7 == ((PORTA) and 07Fh), 6
addwf PCL, f
retlw 11011011B ;2
retlw 11001111B ;3
retlw 11100110B ;4
